...
@ApiResponse(
        responseCode = "401", description = "User is unauthenticated", content = @Content(
        mediaType = "application/json", schema = @Schema(implementation = ErrorResponseDto.class)))
@ApiResponse(
        responseCode = "403", description = "User does not have the correct privilege for resource", content = @Content(
        mediaType = "application/json", schema = @Schema(implementation = ErrorResponseDto.class)))
@ApiResponse(
...
public class PetController {
    ...
    @ApiResponse(
            responseCode = "201", description = "Created pet", content = @Content(
    ...
    @ApiResponse(
            ...
            mediaType = "application/json", schema = @Schema(implementation = ValidationErrorResponseDto.class)))
    public ResponseEntity<PetResponseDto> createPet(@Valid @RequestBody CreatePetRequestDto createPetRequestDto)
    ...
    @ApiResponse(
            responseCode = "200", description = "Got all pets", content = @Content(
            mediaType = "application/json", schema = @Schema(implementation = PetResponseDto[].class)))
    ...
    @ApiResponse(
            responseCode = "200", description = "Got pet", content = @Content(
            mediaType = "application/json", schema = @Schema(
            implementation = PetResponseDto.class)))
    @ApiResponse(
            responseCode = "404", description = "Pet not found", content = @Content(
            mediaType = "application/json", schema = @Schema(
    ...
    @ApiResponse(
            responseCode = "200", description = "Updated pet", content = @Content(
            mediaType = "application/json", schema = @Schema(implementation = PetResponseDto.class)))
    @ApiResponse(
            responseCode = "400", description = "Validation failed", content = @Content(
            mediaType = "application/json", schema = @Schema(implementation = ValidationErrorResponseDto.class)))
    ...
    public ResponseEntity<PetResponseDto> updatePet(
            @PathVariable Integer id, @Valid @RequestBody UpdatePetRequestDto updatePetRequestDto
    ...
    @ApiResponse(
            responseCode = "200", description = "Got all user's pets", content = @Content(
            mediaType = "application/json", schema = @Schema(implementation = PetResponseDto[].class)))
    public ResponseEntity<List<PetResponseDto>> getAllUserPets(
            @AuthenticationPrincipal Jwt jwt, @RequestParam(required = false) String sortBy,
    ...
    @ApiResponse(
            responseCode = "200", description = "Got user's pet", content = @Content(
            mediaType = "application/json", schema = @Schema(implementation = PetResponseDto.class)))
    @ApiResponse(
            responseCode = "404", description = "Pet not found", content = @Content(
            mediaType = "application/json", schema = @Schema(implementation = ErrorResponseDto.class)))
    ...
    @ApiResponse(
            responseCode = "200", description = "Perform action with user's pet to modify their status",
            content = @Content(
                    mediaType = "application/json", schema = @Schema(implementation = PetResponseDto.class)))
    @ApiResponse(
            responseCode = "400", description = "Validation failed", content = @Content(
    ...
    public ResponseEntity<PetResponseDto> patchUserPetStatus(
            @AuthenticationPrincipal Jwt jwt, @PathVariable Integer id,
    ...
    @GetMapping("/pets")
    @ApiResponse(
            responseCode = "200", description = "Got all unadopted pets", content = @Content(
            mediaType = "application/json", schema = @Schema(implementation = PetResponseDto[].class)))
    ...
    @GetMapping("/pets/{id}")
    @ApiResponse(
            responseCode = "200", description = "Got unadopted pet", content = @Content(
            mediaType = "application/json", schema = @Schema(implementation = PetResponseDto.class)))
    @ApiResponse(
            responseCode = "404", description = "Pet not found", content = @Content(
            mediaType = "application/json", schema = @Schema(implementation = ErrorResponseDto.class)))
    ...
    @ApiResponse(
            responseCode = "200", description = "Adopt a pet as the current user", content = @Content(
            mediaType = "application/json", schema = @Schema(implementation = PetResponseDto.class)))
    @ApiResponse(
            responseCode = "404", description = "Pet not found", content = @Content(
            mediaType = "application/json", schema = @Schema(implementation = ErrorResponseDto.class)))
    ...
    throws URISyntaxException, ResourceNotFoundException {
        ...
        var location = new URI(String.format("/pets/%s/adoptions/%s", id, petResponseDto.adoption()
                                                                                        .getId()));
        return ResponseEntity.created(location)
                             .body(petResponseDto);
    }
